...
<html>
	<head>
		<title>大学生登录页</title>
		<meta name=\"description\" content=\"马上登录，查看你的状态。\">
		<meta name=\"keywords\" content=\"登录网站\">
<?php
...
<!--登录-->
		<div class="container">
			<form class="form-signin" action="" method="post">
				...
				<input type="text" name="user" id="inputUser" value="<?php echo htmlspecialchars($_POST["user"]);?>" class="form-control" placeholder="输入账号" required autofocus>
				<?php } elseif(isset($_COOKIE["user"])) { ?>
				<input type="text" name="user" id="inputUser" value="<?php echo htmlspecialchars($_COOKIE["user"]);?>" class="form-control" placeholder="输入账号" required autofocus>
				<?php } else { ?>
				<input type="text" name="user" id="inputUser" value="" class="form-control" placeholder="输入账号" required autofocus>
				<?php } ?>
